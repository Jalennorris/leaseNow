...
export default {
    ...
    createPayment: async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            const result = await pool.query(
                'INSERT INTO payments (lease_id, payment_date, amount) VALUES ($1, $2, $3) RETURNING *',
    ...
    updatePayment: async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            // Update payment
            const result = await pool.query(
                'UPDATE payments SET lease_id = $1, payment_date = $2, amount = $3, payment_status = $4 WHERE payment_id = $5 RETURNING *',
                [lease_id, payment_date, amount, payment_status, id]
            );
